...
/**
 * Many variants of object encoding.
 * In the lectures, we only look at the first two.
 */
...
( () => {
    ...
    // ok.push(outer( inner ) === );          // guess what
...
;    };
    ...
    ok.push(! Person.prototype);                    // they do not even have a prototype property

    // we cannot even check this way
    // ok.push(good instanceof Person);
